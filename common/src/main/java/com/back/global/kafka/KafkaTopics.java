...
public class KafkaTopics {
    ...
    // Market events
    public static final String MARKET_MEMBER_CREATED = "market.member.created";
    ...
    // Cash events
    public static final String CASH_MEMBER_CREATED = "cash.member.created";
    ...
    // Payout events
    public static final String PAYOUT_MEMBER_CREATED = "payout.member.created";
